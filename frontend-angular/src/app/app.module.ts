...
import { ConfirmarLogoutDialogComponent, LayoutComponent } from './shared/components/layout/layout.component';
...
import { QaPantalla4Component, QaSuiteVistaPreviaDialogComponent } from './pages/qa-pantalla-4/qa-pantalla-4.component';
...
@NgModule({
  declarations: [
    ...
    LoginComponent,
    QaAsistenteComponent,
    QaPantalla1Component,
    QaPantalla3Component,
    QaPantalla4Component,
    QaSuiteVistaPreviaDialogComponent,
    QaSopLoomComponent,
    QaCasosComponent,
    QaReglasValidacionComponent,
    QaEstadisticasComponent
  ],
  imports: [
    BrowserModule,
